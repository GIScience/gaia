...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Compute population with access to education, hospitals, and primary healthcare facilities by chosen admin level."
    )
    ...
    try:
        ...
        gdf_admin = gpd.read_file(admin_geojson)

        csv_path = compute_access_population(
            country_code, admin_level, gdf_admin, temp_dir, output_dir, context
        )
